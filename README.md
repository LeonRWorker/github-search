# Github Search - Desafio Frontend Mentor

## 💬 Sobre

Esse projeto é um desafio proposto pelo site [Frontend Mentor](https://www.frontendmentor.io/challenges/github-user-search-app-Q09YOgaH6 "Ver desafio"), que consiste em uma ferramenta para encontrar usuários do GitHub e obter algumas informações sobre eles.
...
```bash
# Clonar repositório
git clone https://github.com/leonrworker/github-search
...
git github-search -b feature/sua-feature ou git github-search -b bugfix/seu-bug
